...
//================================================================================================================================================
public class powerUp2VSMode : MonoBehaviour 
{
	...
	{
		if (other.tag == "bolt" ) //if the power up hit the bolt from player two it will increase by 25
		{
			Destroy (gameObject);
		...
		else if(other.tag == "bolt2" ) //if the power up hit the bolt from player one it will increase by 25
		{
			Destroy (gameObject);
			Destroy (other.gameObject);
